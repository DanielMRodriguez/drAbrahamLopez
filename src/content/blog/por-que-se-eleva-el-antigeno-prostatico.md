---
title: "Por qué se eleva el antígeno prostático (PSA)"
...
1. **Repite el análisis** en unas semanas, ya que factores temporales (infección, actividad reciente) pueden distorsionar un solo resultado.
2. **Realiza tacto rectal** para evaluar tamaño, forma y consistencia de la próstata.
3. **Solicita un ultrasonido prostático** para medir el volumen glandular y calcular la densidad de PSA.
4. **Considera una biopsia** solo si, tras estos pasos, persiste una sospecha razonable — no es el primer paso automático ante un PSA elevado.
